...
const TARGET_PATTERNS: { pattern: RegExp; location?: string }[] = [
  ...
  { pattern: /大法师/, location: "npc_archmage" },
  { pattern: /老国王|国王/, location: "npc_old_king" },
  { pattern: /主教/, location: "npc_bishop" },
  { pattern: /王子/, location: "role_prince" },
  { pattern: /圣女/, location: "role_saintess" },
  { pattern: /刺客/, location: "role_assassin" },
  { pattern: /骑士/, location: "role_knight" },
